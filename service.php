        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="breadcrumb-inner ptb--100 ptb_sm--100 text-center">
                    ...
                    <div class="meta">
                        <a href="index-main.php" class="prev"><i class="fa-solid fa-house"></i> Home</a>
...
<style>
    ...
    .service-zigzag-content .service-title::after {
        ...
        width: 60px;
        height: 3px;
        background: linear-gradient(90deg, #f37538, #f9a825);
        border-radius: 2px;
    }
    ...
    .service-zigzag-image::before {
        ...
        right: 0;
        bottom: 0;
        background: linear-gradient(135deg, rgba(243, 117, 56, 0.1) 0%, transparent 50%);
        z-index: 1;
        pointer-events: none;
    }
    ...
    .service-btn-zigzag {
        ...
        gap: 10px;
        padding: 14px 30px;
        background: linear-gradient(135deg, #f37538 0%, #f9a825 100%);
        color: #fff;
        border-radius: 50px;
        font-weight: 600;
        text-decoration: none;
        transition: all 0.3s ease;
        box-shadow: 0 10px 30px rgba(243, 117, 56, 0.3);
        width: fit-content;
    }
...
<div class="services-zigzag-wrapper">
            ...
            <div class="row align-items-center g-5">
                <div class="col-lg-6" data-sal="slide-right" data-sal-duration="800">
                    <div class="service-zigzag-content">
                        ...
                        <p class="service-desc">We hold years of experience and knowledge of rendering services for Heavy Steel Structures fabrication. To render offered fabrication services for heavy steel structures, we have appointed a team of adroit professionals who follow industry set guidelines and ensure execution within stipulated time frame.</p>
                        <ul class="service-features">
                            ...
                            <li><i class="fa-solid fa-check-circle"></i> Piping - Carbon Steel, Alloy Steel & Stainless Steel</li>
                            <li><i class="fa-solid fa-check-circle"></i> Static & Rotary Equipment Erection</li>
                        </ul>
                        <a href="contact.html" class="service-btn-zigzag">Get Quote <i class="fa-solid fa-arrow-right"></i></a>
                    </div>
                </div>
    ...
    <section class="service-zigzag-section" id="mechanical-maintenance">
        <div class="container-3">
            <div class="row align-items-center g-5">
                <div class="col-lg-6 order-lg-2" data-sal="slide-left" data-sal-duration="800">
                    <div class="service-zigzag-content">
                        <span class="service-number">02</span>
                        <h2 class="service-title">Mechanical Maintenance</h2>
                        <p class="service-desc">We undertake Mechanical Maintenance of heat exchangers, Vessels, Columns, Filters. Repairs & Maintenance of exchangers, heaters, dryers & Furnace to large Public & Private sector undertaking. Driven with superiority, we present top class services for Heat Exchanger Maintenance.</p>
                        <ul class="service-features">
                ...
                <div class="col-lg-6 order-lg-1" data-sal="slide-right" data-sal-duration="800">
                    <div class="service-zigzag-image">
            ...
            <div class="row align-items-center g-5">
                <div class="col-lg-6" data-sal="slide-right" data-sal-duration="800">
                    <div class="service-zigzag-content">
                        ...
                        <p class="service-desc">We are engaged in manufacturing wide gamut of Roofing and Wall Cladding Products. These are fabricated using top quality materials sourced from reliable vendors. Our products are well known for quality and longer service life.</p>
                        <ul class="service-features">
            ...
            <div class="row align-items-center g-5">
                <div class="col-lg-6 order-lg-2" data-sal="slide-left" data-sal-duration="800">
                    <div class="service-zigzag-content">
                        ...
                        <p class="service-desc">We are engaged in rendering unparalleled Blasting, Painting & Coating Services. We are one of the leading contractors executing Sandblasting and all types of Industrial Painting Contracts, providing quality solutions in corrosion protection.</p>
                        <ul class="service-features">
            ...
            <div class="row align-items-center g-5">
                <div class="col-lg-6" data-sal="slide-right" data-sal-duration="800">
                    <div class="service-zigzag-content">
                        ...
                        <p class="service-desc">We are one of the prestigious service providers involved in offering Contractor Labour for Construction and other industries. These services are rendered by highly dedicated, punctual, obedient and hardworking professionals with years of experience.</p>
                        <ul class="service-features">
            ...
            <div class="row align-items-center g-5">
                <div class="col-lg-6 order-lg-2" data-sal="slide-left" data-sal-duration="800">
                    <div class="service-zigzag-content">
                        ...
                        <p class="service-desc">Liquid Separation is the basic function of High Rate Thickener (HRT). We are executing components fabrication for HRT (export quality) at M/s Tenova India Private Limited's workshop, Bangalore - part of Tenova Mining and Minerals Division of Tenova S.P.A, Italy.</p>
                        <ul class="service-features">
                ...
                <div class="col-lg-6" data-sal="slide-right" data-sal-duration="800" data-sal-delay="000">
                    <div class="left-side-content">
                        ...
                        <div class="content">
                            ...
                            <p class="desc">We have experienced Engineers & Supervisors, Skilled Manpower with ample tools & tackles to execute multiple projects and jobs at same time. Reliable, efficient, and tailored to your needs.</p>
                        </div>
...
<section class="tmp-working-process-area tmp-section-gap bg-white">
    <div class="container-3">
        <div class="section-title-area-3">
            <p class="sub-title cg" data-sal="slide-up-large" data-sal-duration="800" data-sal-delay="200">Our Approach</p>
            <h2 class="section-title" data-sal="slide-up-large" data-sal-duration="800" data-sal-delay="400">How We Deliver Excellence</h2>
        </div>
                ...
                <div class="col-lg-4 col-md-6" data-sal="slide-right" data-sal-duration="800" data-sal-delay="100">
                    <div class="working-process-wrapper6 cp-none">
                        <div class="content">
                            ...
                            <p class="desc">Our experienced Engineers & Supervisors assess your project requirements and provide tailored solutions for Power Plants, Steel Plants & Refineries.</p>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4 col-md-6" data-sal="slide-right" data-sal-duration="800" data-sal-delay="300">
                    <div class="working-process-wrapper6 cp-none">
                        <div class="content">
                            ...
                            <p class="desc">With ample tools & tackles, our skilled manpower executes multiple projects simultaneously while maintaining highest quality standards.</p>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4 col-md-6" data-sal="slide-right" data-sal-duration="800" data-sal-delay="500">
                    <div class="working-process-wrapper6 cp-none">
                        <div class="content">
                            ...
                            <p class="desc">We deliver reliable, efficient solutions tailored to your needs, serving large Public & Private sector undertakings with excellence.</p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="col-lg-4">
                <div class="content-slider-inner home-ten">
                    <div class="feedback-wrapper">
                        ...
                        <p class="desc">Our commitment to excellence has made us a preferred partner for AM/NS, JSW Steel, Jindal Steel, Essar Steel, L&T Defence, Tata Projects and more.</p>
                            ...
                            <div class="swiper-slide">
                                <div class="testimonial-wrapper4">
                                    ...
                                    <div class="content-area">
                                        ...
                                        <p class="desc">Techno Engineering delivered exceptional fabrication and erection work for our steel plant expansion. Their experienced team and commitment to safety standards is truly commendable.</p>
                            ...
                            <div class="swiper-slide">
                                <div class="testimonial-wrapper4">
                                    ...
                                    <div class="content-area">
                                        ...
                                        <p class="desc">Their mechanical maintenance team handles our heat exchangers, vessels, and columns with exceptional expertise. A reliable partner for all our maintenance needs.</p>
                                        <div class="author-area">
                                            <div class="author-content">
                            ...
                            <div class="swiper-slide">
                                <div class="testimonial-wrapper4">
                                    ...
                                    <div class="content-area">
                                        ...
                                        <p class="desc">Outstanding blasting and painting services for our refinery project. The team's professionalism and quality workmanship exceeded our expectations.</p>
                                        <div class="author-area">
                                            <div class="author-content">
